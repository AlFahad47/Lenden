    ...
    const toastId = toast.custom((t) => (
      ...
      <div className={`${t.visible ? 'animate-enter' : 'animate-leave'} max-w-sm w-full bg-[#0F172A]/90 backdrop-blur-xl border border-[#2C64FF]/30 shadow-[0_20px_50px_rgba(44,100,255,0.2)] rounded-[1.2rem] pointer-events-auto p-4 flex items-center gap-5 relative overflow-hidden`}>
        ...
        <div className="flex-1">
          ...
          <p className="text-[1em] font-black text-[#4DA1FF] tracking-widest uppercase">Verifying</p>
      ...
      <div className="relative w-[31.25em] h-[45em] text-[12px] sm:text-[14px] md:text-[16px] mt-16">
        ...
        >
          ...
          <div className="text-center w-full mt-2">
            ...
            <h2 className="text-[1.8em] font-extrabold text-[#0F172A] tracking-tight">Sign in to Account</h2>
            ...
            <div className="flex justify-center gap-4 mb-4">
              ...
              <button type="button" className="p-2.5 rounded-full border border-slate-200 hover:border-[#2C64FF] hover:bg-[#2C64FF]/5 transition-colors group">
                ...
                <Facebook size={18} className="text-slate-500 group-hover:text-[#2C64FF]" />
              ...
              <button type="button" className="p-2.5 rounded-full border border-slate-200 hover:border-[#2C64FF] hover:bg-[#2C64FF]/5 transition-colors group">
                ...
                <Linkedin size={18} className="text-slate-500 group-hover:text-[#2C64FF]" />

              </button>

            </div>

            <p className="text-[0.8em] font-medium text-slate-500 mb-6">Don't have an account? <Link href="/register" className="text-[#2C64FF] font-bold hover:underline">Sign up</Link></p>
          ...
          <div className="flex-1 w-full px-2">
            ...
            <div className="relative mb-[1.5em]">
              ...
              <label htmlFor="username" className="absolute -top-[0.6em] left-[1em] bg-white px-1 text-[0.7em] font-bold text-[#2C64FF] z-10">Email</label>
            ...
            <div className="flex items-center justify-between mb-6 px-1 mt-[1.2em]">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-[0.8em] font-bold text-[#64748B]">Remember me</span>
          ...
          <div className="mt-4 text-center">
            ...
            <p className="text-[0.7em] font-medium text-slate-400">
              ...
              <Link href="#" className="hover:text-[#2C64FF]">Privacy Policy</Link>

              <span className="mx-2">•</span>

              <Link href="#" className="hover:text-[#2C64FF]">Terms & Conditions</Link>
