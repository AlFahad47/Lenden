...
const PandaLogin: React.FC = () => {
  ...
  return (
    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden selection:bg-[#e6ffa1] selection:text-[#19524c]">
      ...
      <div className="absolute inset-0 bg-[#19524c]/70 backdrop-blur-[5px] -z-10"></div>
...
<p className="text-[0.8em] font-medium text-slate-500 mb-6">
  Don't have an account? <Link href="/register" className="text-[#19524c] font-bold hover:underline">Sign up</Link>
</p>          </div>
