...
const BannerUser: React.FC = () => {
  ...
  const stats = [
    ...
    {
      label: "Transactions",
      value: isApproved ? dbUser?.history?.length || "0" : "0",
    ...
    {
      label: "Points Earned",
      value: isApproved ? `${dbUser?.totalXP || "0"}` : "N/A",
      icon: <BsCoin size={15} />,
    ...
    {
      label: "Rank",
      value: isApproved ? `${dbUser?.rank || "Bronze"}` : "N/A",
      icon: <FaRankingStar size={15} />,
      color: "text-green-400",
        ...
        >
          <div className="flex gap-2">
            ...
            >
              ...
              <ArrowUpRight
                size={14}
                className="ml-1 text-[#94A3B8] opacity-50 group-hover:opacity-100 transition-opacity"
              />
            </motion.button>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="/dashboard">
              ...
              >
                ...
                <ArrowUpRight
                  size={15}
                  className="relative text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform"
                />
              </motion.button>
            </Link>
            <Link href="/wallet">
            ...
            <div
              ...
              style={{
                background: isApproved
                  ? "linear-gradient(130deg, #4DA1FF, #1E50FF)"
                  : "#1e293b",
              }}
            >
              ...
              <div className="flex justify-between items-end">
                <p className="font-mono text-white/75 text-sm tracking-wider">
                  **** **** **** {isApproved ? "4291" : "****"}
                </p>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <Button
                ...
                variant="ghost"
                size="icon"
                className="absolute top-6 right-6 rounded-full bg-gray-100 dark:bg-white/5 text-gray-500 hover:rotate-90"
              >
                <X size={16} />
              </Button>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex gap-3 w-full">
                  <Button
                    ...
                    variant="ghost"
                    size="lg"
                    className="flex-1 rounded-2xl bg-gray-100 dark:bg-white/5 text-sm font-bold text-[#64748B] dark:text-white hover:bg-gray-200"
                  >
                    Later
                  </Button>
                  ...
                  <Button
                    ...
                    variant="novapay"
                    size="lg"
                    className="flex-1 rounded-2xl text-sm font-bold"
                  >
                    Pay Now
                  </Button>
                </div>
