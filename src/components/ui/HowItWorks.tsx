...
const Card = ({ children }: { children: React.ReactNode }) => (
  <div className="group relative rounded-xl md:rounded-2xl lg:rounded-3xl p-[1px] bg-gradient-to-br from-[#0061ff] via-[#00b4ff] to-[#0061ff] hover:scale-[1.02] transition-all duration-500">
    <div className="relative rounded-xl md:rounded-2xl lg:rounded-3xl bg-white/80 dark:bg-[#04090f]/85 backdrop-blur-xl border border-blue-500/30 dark:border-blue-400/30 shadow-md md:shadow-lg lg:shadow-2xl group-hover:shadow-blue-400/40 transition-all duration-500">
      <div className="absolute inset-0 rounded-xl md:rounded-2xl lg:rounded-3xl opacity-0 group-hover:opacity-100 bg-gradient-to-br from-[#0061ff]/20 to-[#00b4ff]/20 blur-xl transition duration-500" />
...
export default function HowItWorksPage() {
  return (
    <div className="relative overflow-hidden min-h-[80vh] bg-gradient-to-br from-[#f0f7ff] via-white to-[#e8f4ff] dark:from-[#040c1a] dark:via-[#04090f] dark:to-[#040c1a] transition-colors duration-500 px-4 md:px-6 py-12 md:py-16">
      {/* Background Blobs */}
      ...
      <div className="w-11/12 max-w-[1280px] mx-auto">
        ...
        <section className="relative mt-8 md:mt-10 grid sm:grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 lg:gap-5">
          {steps.map((step, index) => (
            ...
            >
              <Card>
                <CardContent>
                  <div className="text-xl md:text-2xl lg:text-4xl font-extrabold bg-gradient-to-r from-[#0061ff] to-[#00d4ff] dark:from-[#93C5FD] dark:to-[#0061ff] bg-clip-text text-transparent">
                    0{index + 1}
                  </div>
        ...
        <section className="relative mt-14 md:mt-20 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.9 }}
            className="group relative rounded-2xl md:rounded-3xl p-[1px] bg-gradient-to-br from-[#0061ff] via-[#00b4ff] to-[#0061ff] shadow-xl md:shadow-2xl hover:scale-[1.02] transition-all duration-500"
          >
            <div className="relative rounded-2xl md:rounded-3xl p-6 md:p-10 bg-white/80 dark:bg-[#04090f]/85 backdrop-blur-2xl border border-blue-500/30 dark:border-blue-400/30 overflow-hidden">
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-br from-[#0061ff]/20 to-[#00b4ff]/20 blur-xl transition duration-500" />
